...
AVLeanCloud.init({
  appId: '3ombsmvdSO3m3PenmpGVmEc0-gzGzoHsz',
  appKey: 'TbDjKcV9oJXU00gXwrVx1wqx'
})
App({
  globalData: {
    // 设备信息，主要用于获取屏幕尺寸而做适配
    ...
    // 用户信息
    userInfo: {
      avatarUrl: "https://pic4.zhimg.com/e515adf3b_xl.jpg",
      nickName: "小闹钟",
      gender: "♂",  // 0, male; 1, female
      meta: '1篇日记',
      username: "",
      coordinate:{latitude:30,longtitude:120}
    },
